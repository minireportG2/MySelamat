...
public class UpdateVaccineActivity extends AppCompatActivity {
    ...
    private void calculate() {
        ...
        if (vaccine_que1.getCheckedRadioButtonId() == -1) {
            Toast.makeText(UpdateVaccineActivity.this, "Please answer Question 1", Toast.LENGTH_SHORT).show();

        } else if (vaccine_que2.getCheckedRadioButtonId() == -1) {
            Toast.makeText(UpdateVaccineActivity.this, "Please answer Question 2", Toast.LENGTH_SHORT).show();

        } else if (vaccine_que3.getCheckedRadioButtonId() == -1) {
            Toast.makeText(UpdateVaccineActivity.this, "Please answer Question 3", Toast.LENGTH_SHORT).show();

        } else if (vaccine_que4.getCheckedRadioButtonId() == -1) {
            Toast.makeText(UpdateVaccineActivity.this, "Please answer Question 4", Toast.LENGTH_SHORT).show();

        } else if ( vaccine_que5.getText().toString().equals("") ) {
            Toast.makeText(UpdateVaccineActivity.this, "Please answer Question 5", Toast.LENGTH_SHORT).show();
        }else{
